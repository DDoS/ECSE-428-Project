Feature: Downvoting a Question
    ...
    Background:
        ...
        And I have created a question with username "test_username" and question "test question" and details "test details 1" and ID "question1"
    ...
    Scenario: [Normal] Downvoting a Question From a List of Questions
        Given I open the site "/questions/find"
        When I downvote the question with ID "question1"
    ...
    Scenario: [Alternate] Downvoting a Question From the Question Page
        Given I open the site for the question with ID "question2"
        When I downvote the question with ID "question2"
    ...
    Scenario: [Alternate] Downvoting an Upvoted Question
        Given I open the site "/questions/find"
        When I downvote the question with ID "question3"
        Then I expect the url to contain "/questions/find"
        Then I expect that element ".alert.alert-success" contains the text "Downvote recorded."
        Then I expect the question with ID "question3" to have a score of "-1"

    Scenario: [Alternate] Downvoting an Downvoted Question
        Given I open the site "/questions/find"
        When I downvote the question with ID "question4"
        Then I expect the url to contain "/questions/find"
