Feature: Downvoting a Argument
    As a registered user
    In order to indicate my belief that an argument does not make a valid point supported by evidence and to decrease the chance that other users will see it
    I should be able to downvote that argument
    ...
    Background:
        ...
        And I have upvoted the argument with username "test_username" and question ID "question1" and ID "argument2"
