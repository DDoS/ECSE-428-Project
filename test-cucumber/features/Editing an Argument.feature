...
# Gherkin Acceptance Test for Editing Arguments
	...
	Given I open the site for the question with ID "question1"
        When I select argument "argument2" of question "question1" to edit it
	...
	Given I open the site for the question with ID "question1"
        When I select argument "argument3" of question "question1" to edit it
	...
	Given I open the site for the question with ID "question1"
        When I select argument "argument1" of question "question1" to edit it
