Feature: Finding New Arguments
    ...
    Background:
        ...
        And I have created an argument in favour with username "test_username" and question ID "question1" and text "test argument in favour 1" and ID "argument1"
        ...
        And I have created an argument against with username "test_username" and question ID "question1" and text "test argument against 1" and ID "argument3"
